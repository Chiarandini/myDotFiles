...
--  └                                                          ┘
	...
	s(
		{trig = 't', name = '\\text'},
		{ t('\\text{'), d(1, get_visual_insert_node), t('}') },
		{
			condition = tex_utils.in_mathzone,
			show_condition = tex_utils.in_mathzone
		}
	...
	--  └                                                          ┘
{
	...
	-- bullet
	s({ trig = "bb" , name='bullet'}, { t("\\bullet") }, { condition = tex_utils.in_mathzone, show_condition = tex_utils.in_mathzone }),
	-- {d}{d<>}
	...
	-- alignment
	s(
		{ trig = "==" , name='alighning equals', dscr='text aligns with &'},
		{t('&=')},
		{
	...
	-- create under-script
	s(
	{trig = '__', name = 'create underscore'},
	{t('_{'), i(1), t('}')},
	{
		condition = tex_utils.in_mathzone,
		show_condition = tex_utils.in_mathzone,
	...
	-- -h>
	s(
		{trig = '-h>', name='\to', description = 'to hookrightarrow'},
		t('\\hookrightarrow'),
		{
			condition = tex_utils.in_mathzone,
			show_condition = tex_utils.in_mathzone,
