...
dashboard.section.buttons.val = {
    ...
    dashboard.button( "f", icon.search_file .. "  Find file", ":cd ~/OneDrive/Documents/ | Telescope find_files<CR>"),
    dashboard.button( "o", icon.reference .. "  Old Files"   , ":Telescope oldfiles<CR>"),
    dashboard.button( "r", icon.refactor .. "  Restore Last Session" , "<cmd>lua require('persistence').load({last = true})<cr>"),
